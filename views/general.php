...
<div class="container-fluid">
	<h1><?php echo _('Blocklist Module') ?></h1>
	<?php echo $infohtml ?>
	<div class="display full-border">
		<div class="row">
			<div class="col-sm-12">
				<div class="fpbx-container">
					<form class="fpbx-submit" name="frm_blocklist" action="" method="post" role="form">
						<form autocomplete="off" name="edit" action="" method="post" onsubmit="return edit_onsubmit();">
							<input type="hidden" name="action" value="settings">
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" data-name="blocklist" class="active">
									<a href="#blocklist" aria-controls="blocklist" role="tab" data-toggle="tab">
										<?php echo _("Blocklist") ?>
									</a>
								</li>
							...
							<div class="tab-content display">
								<div role="tabpanel" id="blocklist" class="tab-pane active">
									<?php echo load_view(__DIR__ . '/blgrid.php', array('blocklist' => $blocklist)); ?>
								</div>
								...
								<div role="tabpanel" id="settings" class="tab-pane">
									...
									<div class="element-container">
										...
										<div class="row">
											<div class="col-md-12">
												<span id="goto0-help" class="help-block fpbx-help-block"><?php echo _("Choose where blocklisted calls go") ?></span>
											</div>
										</div>
									</div>
									<!--End Destination-->
